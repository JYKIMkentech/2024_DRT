function [gamma_est, R0_est, V_est, theta_discrete, W_aug, y, OCV] = DRT_estimation_aug(t, ik, V_sd, lambda_hat, n, dt, ~, SOC, soc_values, ocv_values)
    ...
    tau_max = 1800;   % Maximum tau value in seconds
